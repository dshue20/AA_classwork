...
SELECT city, population_estimate_2018 / 1000000.0
FROM cities
WHERE state = 'Texas';
...
FROM cities
WHERE (
  (land_area_sq_mi_2016 > 400 OR population_estimate_2018 > 2000000)
  AND NOT
...
SELECT city, round(population_estimate_2018 / 1000000.0, 2)
FROM cities
WHERE state = 'Texas';
